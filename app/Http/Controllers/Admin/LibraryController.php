...
class LibraryController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if (!isset($validated["slug"])) {
            $originalSlug = $slug;
            $count = 1;
            while (Library::query()->where("slug", $slug)->exists()) {
    ...
    public function show(Library $library): View
    {
        ...
        $users = User::with([
            "roles" => function ($query) use ($library) {
    ...
    public function update(Request $request, Library $library): RedirectResponse
    {
        $validated = $request->validate([
            ...
            "slug" => [
                ...
                "string",
                "max:255",
                "unique:libraries,slug," . $library->id,
            ],
            "icon" => ["nullable", "string", "max:255"],
            "color" => [
                "nullable",
    ...
    public function assignRoleToUser(
        ...
        return back()->with(
            "success",
            "Role assigned to user successfully for this library.",
        );
    }
    ...
    public function removeRoleFromUser(
        ...
        return back()->with(
            "success",
            "Role removed from user successfully for this library.",
        );
    }
}
