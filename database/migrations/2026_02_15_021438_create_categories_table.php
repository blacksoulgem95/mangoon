...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('categories', function (Blueprint $table) {
            ...
            $table->foreignId('parent_id')->nullable()->constrained('categories')->nullOnDelete()->comment('Parent category for hierarchical structure');
            $table->string('icon')->nullable()->comment('Icon for the category');
            $table->string('color', 7)->nullable()->comment('Hex color for the category');
